"""Behavior Diversity classes for swarms."""
...
class bt_diversity(base_ff):
    ...
    def __init__(self, parameter):
        ...
        self.execution_behaviors = [
            ...
            'CompositeDrop', 'MoveAway', 'NeighbourObjects', 
            'IsDropable', 'IsCarrying', 'IsVisitedBefore', 
            'DidAvoidedObj', 'CanMove', 'IsAgentDead']
        ...
        if parameter.params['MULTICARRY'] is True:
            self.execution_behaviors = [
                ...
                'IsInPartialAttached', 'NeighbourObjects', 'DidAvoidedObj', 'CanMove']

        if parameter.params['COMMUNICATION'] is True:
            self.execution_behaviors += [
                'CompositeDropPheromone', 'CompositeSensePheromone', 'CompositeSendSignal',
                'CompositeReceiveSignal', 'PheromoneExists', 'IsSignalActive']
